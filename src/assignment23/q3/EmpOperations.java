...
import java.sql.*;
    ...
    public class EmpOperations {
        ...
        public void showAllRecords(){
            ...
            try {
                ...
                while(resultSet.next()){
                    System.out.println("id : "+resultSet.getInt(1)+" name : "+resultSet.getString(2)+" designation : "+resultSet.getString(3)+" date of joining : "+resultSet.getString(4)+" experience : "+resultSet.getString(5)+" salary : "+resultSet.getInt(6)+" status: "+resultSet.getString(7));
                }
            }
        ...
        void addColumn(){
            try {
                PreparedStatement preparedStatement = connection.prepareStatement("alter table employee add city varchar(25)");
                preparedStatement.execute();
            } catch (SQLException e) {
                throw new RuntimeException(e);
            }
        ...
        void fetch(){
            try {
                ...
                while(resultSet.next()){
                    System.out.println("id : "+resultSet.getInt(1)+" name : "+resultSet.getString(2)+" designation : "+resultSet.getString(3)+" date of joining : "+resultSet.getString(4)+" experience : "+resultSet.getString(5)+" salary : "+resultSet.getInt(6)+" date of joining : "+resultSet.getString(7)+" city : "+resultSet.getString(8));
                }
            } catch (SQLException e) {
                throw new RuntimeException(e);
            }
